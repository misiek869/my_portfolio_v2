				...
				<div className='relative inline-block text-left'>
					<div>
						<button
							...
							type='button'
							className='inline-flex items-center justify-center w-full rounded-sm border border-gray-300 shadow-sm px-4 py-2 bg-neutral-100 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
