...
const Projects = () => {
	...
	return (
		<motion.section
			...
			<h2 className='bg-gradient-to-r to-gray-950  from-purple-950 inline-block text-transparent bg-clip-text text-4xl font-bold tracking-wide capitalize 3xl:text-5xl'>
				{t('projectsTitle')}
			</h2>
